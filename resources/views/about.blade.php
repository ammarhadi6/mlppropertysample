...
<head>
  ...
  <title>About - MLP Properties</title>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-10">
            ...
            <div class="hero-content text-center" data-aos="zoom-in" data-aos-delay="200">
              <h2>Trusted Real Estate Excellence Since 2008</h2>
              <p class="hero-description">know more about us will make your life easier and happier</p>
            </div>
              ...
              <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                  <div class="primary-image-wrap">
                    <img src="{{ asset('assets/img/real-estate/property-exterior-4.webp') }}" alt="Luxury Property" class="img-fluid">
                ...
                <div class="col-lg-6">
                  <div class="secondary-image-wrap">
                    <img src="{{ asset('assets/img/real-estate/agent-3.webp') }}" alt="Professional Agent" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="testimonial-card">
                ...
                <div class="testimonial-author">
                  <div class="author-image">
                    <img src="{{ asset('assets/img/person/person-f-8.webp') }}" alt="Client" class="img-fluid">
                  </div>
